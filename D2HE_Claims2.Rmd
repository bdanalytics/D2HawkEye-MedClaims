...
title: "Medical Claims: D2HawkEye : PoorCare classification:: Claims2"
author: "bdanalytics"
...
setwd("~/Documents/Work/Courses/MIT/Analytics_Edge_15_071x/Lectures/LCTR3_D2HawkEye_MedClaims")
```
...
model_id <- "Csm.1"; indep_vars_vctr <- c("OfficeVisits", "NarcoticsNULL")
for (method in c("glm")) {
    ret_lst <- myfit_mdl(model_id=model_id, model_method=method,
                                indep_vars_vctr=indep_vars_vctr,
                                model_type=glb_model_type,
